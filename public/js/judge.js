...
Pageantus.UI = {
    ...
    initSliders: function() {
            ...
            slide: function(event,ui){
                ...
                Pageantus.Variables.results[$(this).attr('id')].score = ui.value;
        ...
        sliderOptions.slide = function(event,ui){
            ...
            Pageantus.Variables.results[Pageantus.Variables.current].score = ui.value;
            if(Pageantus.Variables.categories.length==1)
                if(($('.candidate .changed').length/2==Pageantus.Variables.candidates.length)&&Pageantus.Variables.toSubmit>0)
                    Pageantus.UI.toggleBottomPane(true);
        };
    ...
    listCandidates: function() {
        ...
        for (var i = 0; i < candidates.length; i++) {
            ...
            var categories = Pageantus.Variables.categories;
                ...
                Pageantus.Variables.results.push({
...
Pageantus.AJAX = {
    ...
    toSubmit: function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                if (!Pageantus.Variables.submitted && data == true && $('.candidate .changed').length / 2 == Pageantus.Variables.candidates.length) {                    
                            Pageantus.UI.toggleBottomPane(true);
                    }
                    else {
    ...
    submitScores: function() {
        if (Pageantus.Variables.userID != '') {
            Pageantus.Dialog.show('confirm', 'Confirm Score Submission', 'Submit scores for this category?',
                    function() {
